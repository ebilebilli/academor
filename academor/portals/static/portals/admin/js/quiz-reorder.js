/**
 * Drag-and-drop reorder for Quiz admin changelist.
 * Prefer filtering by category first; saves order via POST.
 */
(function () {
  "use strict";
  ...
  ready(function () {
    var configEl = document.getElementById("quiz-reorder-config");
    ...
    var dragRow = null;
    var statusEl = document.getElementById("quiz-reorder-status");
    ...
    rows.forEach(function (row) {
      row.classList.add("quiz-sortable-row");
