...
from portals.views.views_v1 import (
    ...
    ParentLessonsView,
    ParentQuizCategoryDetailView,
    ParentQuizzesView,
    ParentQuizResultsView,
    ParentScheduleView,
    ParentScoresView,
    PortalDashboardView,
...
urlpatterns = [
    ...
    path('parent/quizzes/', ParentQuizzesView.as_view(), name='parent-quizzes'),
    path(
        'parent/quizzes/category/<int:category_pk>/',
        ParentQuizCategoryDetailView.as_view(),
        name='parent-quiz-category',
    ),
    path('parent/attendance/', ParentAttendanceView.as_view(), name='parent-attendance'),
    path('parent/quiz-results/', ParentQuizResultsView.as_view(), name='parent-quiz-results'),
