...
from portals.views.customer_views import (
    ...
    CustomerMockPaymentStartView,
)
from portals.views.customer_mock_views import (
    CustomerIeltsMockCompleteLegacyView,
...
from portals.views.customer_quiz_views import (
    ...
    CustomerQuizSubmitView,
    CustomerQuizTakeView,
    CustomerReadingQuizSubmitView,
    CustomerReadingQuizTakeView,
    CustomerSpeakingQuizSubmitView,
    CustomerSpeakingQuizTakeView,
)
from portals.views.mock_test_views import (
    ParentIeltsMockDetailView,
    ParentMockDetailView,
    StudentIeltsMockCompleteView,
    StudentIeltsMockLegacyRedirectView,
    StudentIeltsMockStartView,
    StudentMockCompleteView,
    StudentMockLandingView,
    StudentMockPickerView,
    StudentMockStartView,
    TeacherIeltsMockDetailView,
    TeacherMockDetailView,
)
...
urlpatterns = [
    ...
    path(
        'teacher/students/<int:student_pk>/mock-access/<slug:program>/',
    ...
    path('student/mock/', StudentMockPickerView.as_view(), name='student-mock-picker'),
    path('student/mock/<slug:program>/', StudentMockLandingView.as_view(), name='student-mock-landing'),
    path('student/mock/<slug:program>/start/', StudentMockStartView.as_view(), name='student-mock-start'),
    path(
        'student/mock/<slug:program>/<int:pk>/complete/',
        StudentMockCompleteView.as_view(),
        name='student-mock-complete',
    ),
    path('student/ielts-mock/', StudentIeltsMockLegacyRedirectView.as_view(), name='student-ielts-mock'),
    ...
    path('teacher/mock/<int:pk>/', TeacherMockDetailView.as_view(), name='teacher-mock-detail'),
    ...
    path(
        'customer/mock/<slug:program>/<int:pk>/complete/',
        CustomerMockCompleteView.as_view(),
        name='customer-mock-complete',
    ),
    path('customer/ielts-mock/', CustomerIeltsMockLegacyRedirectView.as_view(), name='customer-ielts-mock'),
    path('customer/ielts-mock/start/', CustomerIeltsMockStartLegacyView.as_view(), name='customer-ielts-mock-start'),
    path(
        'customer/ielts-mock/<int:pk>/complete/',
        CustomerIeltsMockCompleteLegacyView.as_view(),
    ...
    path(
        'customer/mock-packages/buy/<slug:slug>/',
        CustomerMockPaymentStartView.as_view(),
        name='customer-mock-payment-start',
    ),
    ...
    path('customer/quizzes/<int:pk>/take/', CustomerQuizTakeView.as_view(), name='customer-quiz-take'),
    path('customer/quizzes/<int:pk>/submit/', CustomerQuizSubmitView.as_view(), name='customer-quiz-submit'),
    ...
    path('parent/homework/<int:pk>/', ParentHomeworkDetailView.as_view(), name='parent-homework-detail'),
    path('parent/scores/', ParentScoresView.as_view(), name='parent-scores'),
    path('parent/mock/<int:pk>/', ParentMockDetailView.as_view(), name='parent-mock-detail'),
