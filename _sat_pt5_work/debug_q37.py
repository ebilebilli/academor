...
located = rb.find_marker_on_pages(doc, pstart, pend, 15)
pidx, marker = located
page = doc[pidx]
markers = rb.question_markers(page)
y_bottom = rb.question_band_bottom(page, marker, markers)
print("marker", marker["bbox"], "y_bottom", y_bottom)
...
for L, lr, cr in choices:
    print("choice", L, "letter_rect", lr, "content_rect", cr)

print("---- all spans in band ----")
