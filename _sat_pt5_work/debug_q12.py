...
located = rb.find_marker_on_pages(doc, pages["math1"], pages["math1_end"], 12)
pidx, marker = located
page = doc[pidx]
    ...
    for line in block.get("lines", []):
        for span in line.get("spans", []):
            ...
            if not band.intersects(r):
                continue
            print(f"y0={r.y0:.1f} y1={r.y1:.1f} x0={r.x0:.1f} x1={r.x1:.1f} flags={span.get('flags')} text={span['text']!r}")
